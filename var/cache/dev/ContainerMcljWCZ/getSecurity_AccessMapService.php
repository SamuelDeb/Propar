...
class getSecurity_AccessMapService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin'), [0 => 'ROLE_EXPERT'], NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/chiffre/affaire'), [0 => 'ROLE_EXPERT'], NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/ajout/utilisateur'), [0 => 'ROLE_EXPERT'], NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/ajout_operation'), [0 => 'ROLE_APPRENTI'], NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/lister_operations'), [0 => 'ROLE_APPRENTI'], NULL);
