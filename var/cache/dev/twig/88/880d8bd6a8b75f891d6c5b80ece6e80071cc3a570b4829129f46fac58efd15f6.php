...
class __TwigTemplate_e552a8a75d220512aabd8e6f0ac2d54bc384fb0349d249096fd1e4c6f7a9ba66 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        echo "<form method=\"post\" style=\"margin-left:30%; margin-right:30%;margin-top:5%; margin-bottom:15%\">
    ";
        // line 7
    ...
    <input type=\"text\" value=\"";
        ...
        echo "\" name=\"identifiant\" id=\"inputIdentifiant\" class=\"form-control\" autocomplete=\"username\" required autofocus>
    ...
    ";
        // line 37
        echo "
    <button class=\"btn btn-lg btn-primary\" type=\"submit\" style=\"margin-top:5%\">
        Connexion
    </button>
</form>
";
...
{% block body %}
<form method=\"post\" style=\"margin-left:30%; margin-right:30%;margin-top:5%; margin-bottom:15%\">
    {% if error %}
    ...
    {% if app.user %}
        <div class=\"mb-3\">
            Vous êtes connecté en {{ app.user.userIdentifier }}, <a href=\"{{ path('app_logout') }}\">Déconnexion</a>
        </div>
    {% endif %}
...
{% endblock %}
", "security/login.html.twig", "C:\\Users\\Utilisateur\\Desktop\\Propar\\projet_symfony_propar\\templates\\security\\login.html.twig");
    }
}
